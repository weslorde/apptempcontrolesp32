...
import '../lib2/pages/notificationAlarm.dart';
...
Future<List<bool>> status() async {
  ...
  return [await FlutterBluePlus.isOn, await location.serviceEnabled()];
}
...
blueScan(void Function(bool) inConBlueChange) async {
  ...
  final Future<void> scanResult = await flutterBluePlus.startScan(timeout: const Duration(seconds: 3));
  bool findDisp = false;
